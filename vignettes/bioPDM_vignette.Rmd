...
ex1_output <- radPDM::getDirectionsOfMed(data_list = reduced_mediator, nPDM = 2)
```
...
radPDM::plotMedPathCoeff(ex1_output$pathCoeff) 
```
...
radPDM::printMedPathCoeff(ex1_output$pathCoeff) 
```
